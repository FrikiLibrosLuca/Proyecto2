...
<section>
			<form:form method="GET" modelAttribute="empleado" class="form-control" action="guardar_Empleado">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-3 control-label" for="categoria">Nombre de la categoría : </label>
                        <div class="col-md-7">
                            <form:input value="${empleado.categoria.id}" type="text" path="categoria" id="categoria" class="form-control"/>
                            <div class="has-error">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-3 control-label" for="departamento">Nombre del departamento : </label>
                        <div class="col-md-7">
                            <form:input value="${empleado.departamento.id}" type="text" path="departamento" id="departamento" class="form-control"/>
                            <div class="has-error">
