...
<section>
	<form:form method="GET" modelAttribute="empleado" class="form-control"
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-label" for="categoria">ID
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-label" for="categoria">Nombre
					de la categoría : </label>
				<div class="col-md-7">
					<form:input value="${empleado.categoria.nombre}" type="text"
						path="categoria" id="categoria" class="form-control" />
					<div class="has-error">
						<form:errors path="categoria" class="help-inline" />
					</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-label" for="categoria">Descripción
					de la categoría : </label>
				<div class="col-md-7">
					<form:input value="${empleado.categoria.descripcion}" type="text"
						path="categoria" id="categoria" class="form-control" />
					<div class="has-error">
						<form:errors path="categoria" class="help-inline" />
					</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-label" for="departamento">ID
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-label" for="departamento">Nombre
					del departamento : </label>
				<div class="col-md-7">
					<form:input value="${empleado.departamento.nombre}" type="text"
						path="departamento" id="departamento" class="form-control" />
					<div class="has-error">
						<form:errors path="departamento" class="help-inline" />
					</div>
